...
public class ConstructionMaterialDungeon implements MaterialBase {
	...
	DUNGEON_BRICK_BROKEN = mat.BLOCKS.register(mat.name + "_dungeon_brick_broken",
		() -> new Block(Block.Properties.create(Material.IRON).harvestLevel(4)
			.hardnessAndResistance(50.0F, 1200.0F).harvestTool(ToolType.PICKAXE)));
	DUNGEON_BRICK_TRIM = mat.BLOCKS.register(mat.name + "_dungeon_brick_trim",
		() -> new BlockVerticalPlacement(Block.Properties.create(Material.IRON).harvestLevel(4)
			.hardnessAndResistance(50.0F, 1200.0F).harvestTool(ToolType.PICKAXE)));
	DUNGEON_PILLAR = mat.BLOCKS.register(mat.name + "_dungeon_brick_pillar",
		() -> new RotatedPillarBlock(Block.Properties.create(Material.IRON).harvestLevel(4)
			.hardnessAndResistance(50.0F, 1200.0F).harvestTool(ToolType.PICKAXE)));
	DUNGEON_SQUARE = mat.BLOCKS.register(mat.name + "_dungeon_brick_square",
		() -> new Block(Block.Properties.create(Material.IRON).harvestLevel(4)
			.hardnessAndResistance(50.0F, 1200.0F).harvestTool(ToolType.PICKAXE)));
	DUNGEON_LAMP = mat.BLOCKS.register(mat.name + "_dungeon_brick_light",
		() -> new Block(Block.Properties.create(Material.IRON).harvestLevel(4)
	...
	DUNGEON_BRICK_BROKEN_ITEMBLOCK = mat.ITEMS.register(mat.name + "_dungeon_brick_broken_itemblock",
		() -> new BlockNamedItem(DUNGEON_BRICK_BROKEN.get(),
			new Item.Properties().group(MetallurgyMaterialHelper.GROUP_METAL)));
	DUNGEON_BRICK_TRIM_ITEMBLOCK = mat.ITEMS.register(mat.name + "_dungeon_brick_trim_itemblock",
		() -> new BlockNamedItem(DUNGEON_BRICK_TRIM.get(),
			new Item.Properties().group(MetallurgyMaterialHelper.GROUP_METAL)));
	DUNGEON_PILLAR_ITEMBLOCK = mat.ITEMS.register(mat.name + "_dungeon_pillar_itemblock",
		() -> new BlockNamedItem(DUNGEON_PILLAR.get(),
			new Item.Properties().group(MetallurgyMaterialHelper.GROUP_METAL)));
	DUNGEON_SQUARE_ITEMBLOCK = mat.ITEMS.register(mat.name + "_dungeon_square_itemblock",
	...
	ModelFile brick1 = model.models()
		.withExistingParent(name + "_dungeon_brick_broken", model.mcLoc("block/cube_all"))
		.texture("all", "compendium:block/material/" + name + "/" + name + "dungeon_bricks_broken");
	ModelFile brick2 = model.models()
		.withExistingParent(name + "_dungeon_brick_broken_2", model.mcLoc("block/cube_all"))
		.texture("all", "compendium:block/material/" + name + "/" + name + "dungeon_bricks_broken_2");
	ModelFile brick3 = model.models()
		.withExistingParent(name + "_dungeon_brick_broken_3", model.mcLoc("block/cube_all"))
	...
	ModelFile trim2 = model.models()
		.withExistingParent(name + "_dungeon_brick_trim_2", model.modLoc("block/bases/dungeon_trim_2"))
		.texture("0", "compendium:block/material/" + name + "/" + name + "dungeon_bricks");
	ModelFile trim3 = model.models()
		.withExistingParent(name + "_dungeon_brick_trim_3", model.modLoc("block/bases/dungeon_trim_3"))
		.texture("0", "compendium:block/material/" + name + "/" + name + "dungeon_bricks");
	ModelFile trim4 = model.models()
		.withExistingParent(name + "_dungeon_brick_trim_4", model.modLoc("block/bases/dungeon_trim_4"))
		.texture("0", "compendium:block/material/" + name + "/" + name + "dungeon_bricks");
