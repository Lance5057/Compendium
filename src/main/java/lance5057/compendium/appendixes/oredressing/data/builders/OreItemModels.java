...
public class OreItemModels {
    public static void registerModels(TCItemModels model) {
	for (OreDressingMaterialHelper mh : AppendixOreDressing.ores) {

	    if (mh.hasOre())
		model.forBlockItem(mh.getOre().ITEM_ORE, mh.name);
	    if (mh.hasDenseOre())
		model.forBlockItem(mh.getDenseOre().ITEM_ORE, mh.name);
	    if (mh.hasSparseOre())
		model.forBlockItem(mh.getSparseOre().ITEM_ORE, mh.name);
...
//				.texture("layer1",
//					model.modLoc("item/material/" + mh.name + "/" + b.BOW.getId().getPath() + "_0"))
...
//				.texture("layer1",
//					model.modLoc("item/material/" + mh.name + "/" + b.BOW.getId().getPath() + "_1"))
...
//				.texture("layer1",
//					model.modLoc("item/material/" + mh.name + "/" + b.BOW.getId().getPath() + "_2"))
