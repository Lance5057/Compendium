...
public class BlockSnuffableLantern extends BlockSnuffable implements IWaterLoggable {
   ...
   public BlockSnuffableLantern(Item item, AbstractBlock.Properties properties) {
