...
//		// From Tag
//		this.createRecipe("plank_to_sticks", SawhorseRecipeLoottables.allplanks, Ingredient.of(ItemTags.PLANKS),
//				consumer, 2);
//
...
//		consumer.accept(new SawHorseStationFinishedRecipe(
...
//	private static class SawHorseStationFinishedRecipe implements FinishedRecipe {
//		private final ResourceLocation id;
//		private final ResourceLocation output;
//		private final Ingredient input;
//		private final int strikes;
//
//		private SawHorseStationFinishedRecipe(ResourceLocation id, ResourceLocation output, Ingredient input,
//				int strikes) {
//			this.id = id;
//			this.output = output;
//			this.input = input;
