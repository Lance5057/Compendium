...
import lance5057.compendium.core.data.builders.workstationrecipes.CraftingAnvilRecipeProvider.AnvilResult;
...
public class AnvilShapedRecipeBuilder {
    ...
    public AnvilShapedRecipeBuilder(IItemProvider resultIn, int countIn, IItemProvider schematicIn) {
    ...
    public static AnvilShapedRecipeBuilder shapedRecipe(IItemProvider resultIn) {
	return shapedRecipe(resultIn, 1, null);
    }

    public static AnvilShapedRecipeBuilder shapedRecipe(IItemProvider resultIn, IItemProvider schematicIn) {
	return shapedRecipe(resultIn, 1, schematicIn);
    }

    public static AnvilShapedRecipeBuilder shapedRecipe(IItemProvider resultIn, int countIn) {
	return new AnvilShapedRecipeBuilder(resultIn, countIn, null);
    }

    public static AnvilShapedRecipeBuilder shapedRecipe(IItemProvider resultIn, int countIn,
	    IItemProvider schematicIn) {
