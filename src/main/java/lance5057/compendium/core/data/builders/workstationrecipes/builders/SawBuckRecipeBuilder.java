...
public class SawBuckRecipeBuilder implements RecipeBuilder {
	...
	public SawBuckRecipeBuilder tool(Ingredient tool, int uses, boolean damage, BlacklistedModel... model) {
		this.tools.add(new AnimatedRecipeItemUse(uses, tool, 1, damage, model));
		return this;
	}

	public SawBuckRecipeBuilder addCriterion(String name, CriterionTriggerInstance criterionIn) {
