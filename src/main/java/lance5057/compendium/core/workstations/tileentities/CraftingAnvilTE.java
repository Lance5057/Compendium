...
public class CraftingAnvilTE extends MultiToolRecipeStation<CraftingAnvilRecipe> implements INamedContainerProvider {
...
//    public int stage = 0;
	...
	super(27, 5, 5, CompendiumTileEntities.CRAFTING_ANVIL_TE.get());
    }
...
//    }
    ...
    @Override
    public void finishRecipe(PlayerEntity playerEntity, CraftingAnvilRecipe r) {
	handler.ifPresent(h -> {
	    ItemStack item = r.getRecipeOutput().copy();
	    TileEntity te = world.getTileEntity(this.getPos().add(0, -1, 0));
	    if (te != null) {
