...
public class MaterialExtraComponents implements MaterialBase {
	...
	public MaterialExtraComponents(MaterialHelper mh) {
		...
		ITEM_SHEET_BLOCK = mh.ITEMS.register(mh.name + "itemsheetblock",
				() -> new BlockItem(SHEET_BLOCK.get(), new Item.Properties().group(TCItems.TCITEMS)));
		...
		ITEM_TOP_BARS = mh.ITEMS.register(mh.name + "itemtopbars",
				() -> new BlockItem(TOP_BARS.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_CHAINLINK_BARS = mh.ITEMS.register(mh.name + "itemchainlink",
				() -> new BlockItem(CHAINLINK_BARS.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_CHAINLINK_BLOCK = mh.ITEMS.register(mh.name + "itemchainlinkblock",
				() -> new BlockItem(CHAINLINK_BLOCK.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_BRAZIER = mh.ITEMS.register(mh.name + "itembrazier",
				() -> new BlockItem(BRAZIER.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_SOUL_BRAZIER = mh.ITEMS.register(mh.name + "itemsoulbrazier",
				() -> new BlockItem(SOUL_BRAZIER.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_WALL = mh.ITEMS.register(mh.name + "itemwall",
				() -> new BlockItem(WALL.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_TRIMMED_WINDOW = mh.ITEMS.register(mh.name + "itemwindowpane",
				() -> new BlockItem(TRIMMED_WINDOW.get(), new Item.Properties().group(TCItems.TCITEMS)));
		ITEM_TRIMMED_WINDOW_BLOCK = mh.ITEMS.register(mh.name + "itemwindow",
				() -> new BlockItem(TRIMMED_WINDOW_BLOCK.get(), new Item.Properties().group(TCItems.TCITEMS)));
