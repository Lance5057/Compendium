...
public class MaterialGemOre implements MaterialBase {
...
//	}
	public MaterialGemOre(String matName, float hardness, int level, String tool, float resistance, int ymax, int ymin,
