...
//		LOCATION_SHIELD_NO_PATTERN = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS_TEXTURE, new ResourceLocation(
//				Reference.MOD_ID, "entity/material/" + name + "/" + name + "shield_base_nopattern"));
//	}
//
//	@Override
