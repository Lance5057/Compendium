package lance5057.compendium.core.client.models;
...
public class HandStatueModel<T extends Entity> extends EntityModel<T> {
	...
	public HandStatueModel(ModelPart root) {
