...
//					.translation("compendium.config.common.general.animated_displays")
//					.define("animated_displays", true);
//		}
//	}
//
//	public static class Materials {
//		public final ForgeConfigSpec.ConfigValue<List<? extends String>> materials;
...
//
//		private static List<String> defaultMaterials = new ArrayList<String>(
//				Arrays.asList("wood:wood", "metal:copper", "metal:iron", "metal:gold", "gem:diamond", "metal:netherite"));
//
//		Materials(ForgeConfigSpec.Builder builder) {
//			materials = builder.comment("materials")
//					.translation("compendium.config.common.materiallist")
//					.defineListAllowEmpty(Collections.singletonList("materials"), () -> defaultMaterials, i -> (i instanceof String));
...
//			retroGenName = builder.comment(
//					"The name used by ore generation to determine if a chunk has been populated. Changing this will mark all chunks for retrogen if enabled.")
