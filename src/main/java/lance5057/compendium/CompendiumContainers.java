...
//
//	public static final RegistryObject<MenuType<CraftingAnvilContainer>> CRAFTING_ANVIL_CONTAINER = CONTAINERS.register("crafting_anvil_container", () -> IForgeMenuType.create(CraftingAnvilContainer::createContainerClientSide));
//
