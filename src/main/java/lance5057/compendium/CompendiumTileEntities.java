...
//	public static final RegistryObject<BlockEntityType<ScrappingTableTE>> SCRAPPING_TABLE_TE = TILE_ENTITIES.register(
//			"scrapping_table_tile",
//			() -> BlockEntityType.Builder.of(ScrappingTableTE::new, CompendiumBlocks.SCRAPPING_TABLE.get()).build(null));
//
