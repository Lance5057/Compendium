...
public class TCBlocks {
	...
	public static final RegistryObject<CraftingAnvilBlock> CRAFTING_ANVIL = BLOCKS.register("crafting_anvil", () -> new CraftingAnvilBlock());
	public static final RegistryObject<SawhorseStationBlock> SAWHORSE_STATION = BLOCKS.register("sawhorse_station", () -> new SawhorseStationBlock());
