...
//
//public class ComponentItemDoor extends Item
//{
//    private final Block block;
//
//    public ComponentItemDoor(Block block)
//    {
//        this.block = block;
...
//        IBlockState iblockstate = door.getDefaultState().withProperty(ComponentDoor.FACING, facing).withProperty(ComponentDoor.HINGE, isRightHinge ? ComponentDoor.EnumHingePosition.RIGHT : ComponentDoor.EnumHingePosition.LEFT).withProperty(ComponentDoor.POWERED, Boolean.valueOf(flag2)).withProperty(ComponentDoor.OPEN, Boolean.valueOf(flag2));
//        worldIn.setBlockState(pos, iblockstate.withProperty(ComponentDoor.HALF, ComponentDoor.EnumDoorHalf.LOWER), 2);
//        worldIn.setBlockState(blockpos2, iblockstate.withProperty(ComponentDoor.HALF, ComponentDoor.EnumDoorHalf.UPPER), 2);
