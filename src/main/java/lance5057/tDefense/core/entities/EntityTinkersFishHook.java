...
//
//public class EntityTinkersFishHook extends EntityFishHook
//{
...
//    private EntityTinkersFishHook.State currentState = EntityTinkersFishHook.State.FLYING;
//    private int luck;
//    private int lureSpeed;
//
//    @SideOnly(Side.CLIENT)
//    public EntityTinkersFishHook(World worldIn, EntityPlayer p_i47290_2_, double x, double y, double z)
//    {
...
//    }
//
//    public EntityTinkersFishHook(World worldIn, EntityPlayer fishingPlayer)
//    {
...
//            }
//
//            if (this.currentState == EntityTinkersFishHook.State.FLYING)
//            {
...
//                    this.motionY = 0.0D;
//                    this.motionZ = 0.0D;
//                    this.currentState = EntityTinkersFishHook.State.HOOKED_IN_ENTITY;
//                    return;
//                }
//
//                if (f > 0.0F)
...
//                    this.motionY *= 0.2D;
//                    this.motionZ *= 0.3D;
//                    this.currentState = EntityTinkersFishHook.State.BOBBING;
//                    return;
//                }
//
...
//            else
//            {
//                if (this.currentState == EntityTinkersFishHook.State.HOOKED_IN_ENTITY)
//                {
//                    if (this.caughtEntity != null)
//                    {
...
//                            this.currentState = EntityTinkersFishHook.State.FLYING;
//                        }
//                        else
//                        {
...
//                }
//
//                if (this.currentState == EntityTinkersFishHook.State.BOBBING)
//                {
//                    this.motionX *= 0.9D;
//                    this.motionZ *= 0.9D;
...
//        boolean flag = itemstack.getItem() instanceof FishingRod;
//        boolean flag1 = itemstack1.getItem() instanceof FishingRod;
//
