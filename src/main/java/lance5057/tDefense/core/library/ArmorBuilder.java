...
//import lance5057.tDefense.core.modifiers.ArmorModifierTrait;
...
//
//	/**
//	 * Takes an array of Itemstacks and tries to build a tool with it. Amount of
//	 * itemstacks has to match exactly.
//	 *
//	 * @param stacks Input.
...
//			Collection<ArmorCore> possibleTools) {
//		int length = -1;
...
//						try {
//							if (modifier instanceof ArmorModifierTrait || modifier instanceof ModifierTDTrait)
...
//					String error = I18n.translateToLocalFormatted("gui.error.no_modifier_for_item",
//							input.get(i).getDisplayName());
...
//			String error = I18n.translateToLocalFormatted("gui.error.not_enough_durability",
//					output.getItemDamage() - output.getMaxDamage());
//			throw new TinkerGuiException(error);
//		}
//
//		return output;
...
//
//	/**
//	 * Takes a pattern and itemstacks and crafts the materialitem of the pattern out
//	 * of it. The output consists of an ItemStack[2] array that contains the part in
//	 * the first slot and eventual leftover output in the 2nd one. The itemstacks
//	 * have to match at least 1 material. If multiple materials match, matches with
//	 * multiple items are preferred. Otherwise the first match will be taken.
//	 *
...
//	 * @return ItemStack[2] Array containing the built item in the first slot and
//	 *         eventual secondary output in the second one. Null if no item could be
//	 *         built.
//	 */
//	public static NonNullList<ItemStack> tryBuildToolPart(ItemStack pattern, NonNullList<ItemStack> materialItems,
//			boolean removeItems) throws TinkerGuiException {
