package lance5057.tDefense.core.library.extendedItems;
...
public class TCCrossbowItem extends ShootableItem {
   ...
   public TCCrossbowItem(IItemTier tier, Item.Properties propertiesIn) {
      super(propertiesIn);
      
      this.attackDamage = tier.getAttackDamage();
      this.drawSpeed = tier.getEfficiency();
   ...
   private static AbstractArrowEntity createArrow(World worldIn, LivingEntity shooter, ItemStack crossbow, ItemStack ammo) {
      ...
      abstractarrowentity.setDamage(abstractarrowentity.getDamage() + ((TCCrossbowItem)crossbow.getItem()).getAdditionalDamage());
