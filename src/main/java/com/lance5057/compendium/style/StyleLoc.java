...
public class StyleLoc {
	public static void StyleNames(LanguageProvider lp) {
		...
		lp.add("style.log_slab.3_beam", "3 Beams");
		lp.add("style.log_slab.3_beam_rotated", "3 Beams (Rotated)");
		lp.add("style.log_slab.beam", "Beam");
		lp.add("style.log_slab.beam_rotated", "Beam (Rotated)");
		lp.add("style.log_slab.small_beam", "Small Beam");
		lp.add("style.log_slab.small_beam_rotated", "Small (Rotated)");
		...
		lp.add("style.plank_slab.alternate_weave", "Alternate Weave");
		lp.add("style.plank_slab.close_weave", "Close Weave");
		lp.add("style.plank_slab.double_weave", "Double Weave");
		...
		lp.add("style.plank_slab.four_panels", "Four Panels");
		lp.add("style.plank_slab.paper", "Paper");
		lp.add("style.plank_slab.greek", "Greek");
		lp.add("style.plank_slab.greek_trimmed", "Trimmed Greek");
		lp.add("style.plank_slab.greek_trimmed_rotated", "Trimmed Greek (Rotated)");
		lp.add("style.plank_slab.greek_caged", "Caged Greek");
		lp.add("style.plank_slab.braid", "Braid");
		lp.add("style.plank_slab.braid_rotated", "Braid (Rotated)");
		lp.add("style.plank_slab.3_slats", "3 Slats");
		lp.add("style.plank_slab.3_slats_rotated", "3 Slats (Rotated)");
		lp.add("style.plank_slab.box_slab", "Box");
		lp.add("style.plank_slab.bracing_cross", "Cross Bracing");
		lp.add("style.plank_slab.diagonal_ornate_bracing", "Diagonal Ornate Bracing");
		lp.add("style.plank_slab.half_box_slab", "Half Box");
		lp.add("style.plank_slab.small_beam", "Small Beam");
		lp.add("style.plank_slab.small_beam_rotated", "Small Beam (Rotated)");
		lp.add("style.plank_slab.ornate_bracing", "Ornate Bracing");
		lp.add("style.plank_slab.small_bracing", "Small Bracing");
		lp.add("style.plank_slab.trellis", "Trellis");
		lp.add("style.plank_slab.straight_trellis", "Straight Trellis");
		lp.add("style.plank_slab.twin_bracing_cross", "Twin Bracing Cross");
		lp.add("style.plank_slab.twin_bracing", "Twin Bracing");
		lp.add("style.plank_slab.twin_bracing_rotated", "Twin Bracing (Rotated)");
