...
public class StyleData {
	...
	public static StyleData METAL_BLOCK = new StyleData("metal_block",
			List.of("heavy_rivet_tile", "brick", "coil", "crate", "cylinder", "dented_tile", "diamond", "diamond_tile",
					"eighth_tile", "half_tile", "heavy_rivet_dented_tile", "no_rivet_dented_tile",
					"no_rivet_diamond_tile", "no_rivet_half_tile", "no_rivet_offset_quarter_tile",
					"no_rivet_quarter_tile", "no_rivet_tile", "offset_eighth_tile", "offset_quarter_tile", "pipe",
					"planks", "seamless_planks", "offset_planks", "quarter_tile", "random_tile", "seamless", "shutter",
