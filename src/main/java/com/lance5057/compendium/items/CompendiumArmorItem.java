...
public class CompendiumArmorItem extends ArmorItem {
	...
	public CompendiumArmorItem(Holder<ArmorMaterial> pMaterial, Type pType, Properties pProperties, String textureLoc) {

		super(pMaterial, pType, pProperties);

		this.textureLoc = ResourceLocation.fromNamespaceAndPath(Compendium.MOD_ID, textureLoc);
	}
