...
public class SpecialTextureLocationsMetal {
	...
	public SpecialTextureLocationsMetal(ResourceLocation blockLocation, ResourceLocation ingotLocation,
	...
	public static class Serializer
			implements JsonSerializer<SpecialTextureLocationsMetal>, JsonDeserializer<SpecialTextureLocationsMetal> {

		@Override
		public SpecialTextureLocationsMetal deserialize(JsonElement json, Type typeOfT,
			...
			return new SpecialTextureLocationsMetal(block, ingot, nugget);
		}

		@Override
		public JsonElement serialize(SpecialTextureLocationsMetal src, Type typeOfSrc,
