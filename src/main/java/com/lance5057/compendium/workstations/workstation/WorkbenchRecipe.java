...
public class WorkbenchRecipe extends MultiToolRecipeShaped {
	...
	public WorkbenchRecipe(String groupIn, int recipeWidthIn, int recipeHeightIn, NonNullList<Ingredient> recipeItemsIn,
			NonNullList<AnimatedRecipeItemUse> recipeToolsIn, ItemStack schematicIn, ItemStack recipeOutputIn) {
		super(groupIn, recipeWidthIn, recipeHeightIn, recipeItemsIn, recipeToolsIn, recipeOutputIn,
