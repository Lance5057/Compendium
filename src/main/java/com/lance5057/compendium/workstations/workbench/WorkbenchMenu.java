...
public class WorkbenchMenu extends AbstractContainerMenu {
	...
	protected WorkbenchMenu(int windowId, final Inventory playerInventory, final MultiToolRecipeStation<?> tileEntity) {
		...
		if (tileEntity != null) {
			...
			this.addSlot(new SlotItemHandler(tileEntity.getInventory(), WorkbenchBlockEntity.UPGRADE_BATTERY, 181, 28));
			this.addSlot(new SlotItemHandler(tileEntity.getInventory(), WorkbenchBlockEntity.UPGRADE_ENERGY, 181, 46));
			this.addSlot(
					new SlotItemHandler(tileEntity.getInventory(), WorkbenchBlockEntity.UPGRADE_LIGHT_SLOT, 181, 64));
