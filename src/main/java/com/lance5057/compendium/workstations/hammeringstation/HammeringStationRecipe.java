...
//
//public class HammeringStationRecipe extends MultiToolRecipe implements IRecipeSingleItemIn, IRecipeSingleItemOut, IRecipeLootTableOut {
//
...
//		super(idIn, groupIn, recipeToolsIn, WorkstationRecipes.HAMMERINGSTATION_RECIPE.get());
//		
...
//
//		public HammeringStationRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
//			String s = GsonHelper.getAsString(json, "group", "");
//			Ingredient itemIn = Ingredient.fromJson(GsonHelper.getAsJsonObject(json, "input"));
//
//			NonNullList<AnimatedRecipeItemUse> nonnulllistTools = HammeringStationRecipe
...
//
//			return new HammeringStationRecipe(recipeId, s, itemIn, itemstack, nonnulllistTools, output);
//		}
//
//		public HammeringStationRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
...
//
//			return new HammeringStationRecipe(recipeId, group, ing, output, tools, outputTable);
//		}
//
