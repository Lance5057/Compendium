...
public class CompendiumArmorModel extends HumanoidModel<LivingEntity> {

	public CompendiumArmorModel(ModelPart root) {
		super(root);
	}

	@Override
	public void setupAnim(LivingEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
