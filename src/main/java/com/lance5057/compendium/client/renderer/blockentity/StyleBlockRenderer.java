...
public class StyleBlockRenderer implements BlockEntityRenderer<StyleBlockEntity> {
...
//			.standalone(Compendium.modLoc("extra/material/wood/invalid/chair/basic/back"));
	...
	public StyleBlockRenderer(BlockEntityRendererProvider.Context cxt) {

	}

	@Override
	public void render(StyleBlockEntity blockEntity, float partialTick, PoseStack poseStack,
